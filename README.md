...
Для большей простоты выделения элементов и понимания их расположения предлагается использовать [ссылка](https://github.com/ArtMan-8/outline-prototype) или аналоги.
